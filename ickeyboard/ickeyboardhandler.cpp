    ...
    pulleyTurn_(0)
{
    ...
    virtualKeyMap_.insert(ICKeyboard::VFB_Y2Sub, IC::VKEY_Y1SUB);
    virtualKeyMap_.insert(ICKeyboard::VFB_Y2Add, IC::VKEY_Y1ADD);
    ...
    virtualKeyMap_.insert(ICKeyboard::VFB_X2Sub, IC::VKEY_X1SUB);
    virtualKeyMap_.insert(ICKeyboard::VFB_X2Add, IC::VKEY_X1ADD);
